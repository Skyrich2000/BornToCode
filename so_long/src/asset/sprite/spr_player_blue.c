...
/*   Updated: 2021/07/22 07:56:59 by ycha             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	init_spr_player_die()
{
	...
	if (!game->asset.spr_player_blue_die_right || \
		!game->asset.spr_player_blue_die_left)
		return (ERROR);
	if (!add_sprite_subimage(game->asset.spr_player_blue_die_right, "./res/xpm/player_blue_right/player_", 18, 22) || \
		!add_sprite_subimage(game->asset.spr_player_blue_die_left, "./res/xpm/player_blue_left/player_", 18, 22))
		return (ERROR);
	return (OK);
}
...
static int	init_spr_player_attack()
{
	...
	if (!game->asset.spr_player_blue_attack_right || \
		!game->asset.spr_player_blue_attack_left)
		return (ERROR);
	if (!add_sprite_subimage(game->asset.spr_player_blue_attack_right, "./res/xpm/player_blue_right/player_", 23, 27) || \
		!add_sprite_subimage(game->asset.spr_player_blue_attack_left, "./res/xpm/player_blue_left/player_", 23, 27))
		return (ERROR);
	return (OK);
}
...
static int	init_spr_player_move()
{
	...
	if (!game->asset.spr_player_blue_move_right || \
		!game->asset.spr_player_blue_move_left)
		return (ERROR);
	if (!add_sprite_subimage(game->asset.spr_player_blue_move_right, "./res/xpm/player_blue_right/player_", 9, 14) || \
		!add_sprite_subimage(game->asset.spr_player_blue_move_left, "./res/xpm/player_blue_left/player_", 9, 14))
		return (ERROR);
	return (OK);
}
...
static int	init_spr_player_idle()
{
	...
	if (!game->asset.spr_player_blue_idle_right || \
		!game->asset.spr_player_blue_idle_left)
		return (ERROR);
	if (!add_sprite_subimage(game->asset.spr_player_blue_idle_right, "./res/xpm/player_blue_right/player_", 0, 8) || \
		!add_sprite_subimage(game->asset.spr_player_blue_idle_left, "./res/xpm/player_blue_left/player_", 0, 8))
		return (ERROR);
	return (OK);
}
