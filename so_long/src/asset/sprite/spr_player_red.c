...
/*   Updated: 2021/08/05 22:53:15 by ycha             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	init_spr_player_die()
{
	...
	game = g();
	game->asset.spr_player_red_die_right = add_sprite(27, 50, 7, (t_box){17, 30, 37, 50});
	game->asset.spr_player_red_die_left = add_sprite(36, 50, 7, (t_box){26, 30, 46, 50});
...
static int	init_spr_player_attack()
{
	...
	game = g();
	game->asset.spr_player_red_attack_right = add_sprite(27, 50, 7, (t_box){17, 30, 64, 50});
	game->asset.spr_player_red_attack_left = add_sprite(36, 50, 7, (t_box){0, 30, 46, 50});
...
static int	init_spr_player_move()
{
	...
	game = g();
	game->asset.spr_player_red_move_right = add_sprite(27, 50, 5, (t_box){17, 30, 37, 50});
	game->asset.spr_player_red_move_left = add_sprite(36, 50, 5, (t_box){26, 30, 46, 50});
	game->asset.spr_player_red_move_right_reverse = add_sprite(27, 50, 5, (t_box){17, 30, 37, 50});
	game->asset.spr_player_red_move_left_reverse = add_sprite(36, 50, 5, (t_box){26, 30, 46, 50});
...
static int	init_spr_player_idle()
{
	...
	game = g();
	game->asset.spr_player_red_idle_right = add_sprite(27, 50, 10, (t_box){17, 30, 37, 50});
	game->asset.spr_player_red_idle_left = add_sprite(36, 50, 10, (t_box){26, 30, 46, 50});
